<template>
    <div id="app">
        ...
        <Breadcrumb name="捏脸分享" slug="face" root="/face" :publishEnable="true" :feedbackEnable="true" :crumbEnable="true">
            <template slot="op-append"  v-if="isSinglePage">
                ...
                <template v-if="isEditor || isAuthor">
                    <div class="m-face-btn-box">
<!--                        <el-button-->
<!--                            type="danger"-->
<!--                            class="u-publish u-btn"-->
            ...
            this.$confirm('确认' + (this.status==1 ? '下架' : '上架') + '该捏脸？', '提示', {
                ...
                beforeClose: (action, instance, done) => {
                    if (action === 'confirm') {
                        ...
                        if (this.status==1) {
                            //下架
                            offlineFace(this.id,this.isEditor).then(() => {
                            ...
                            //上架
                            onlineFace(this.id,this.isEditor).then(() => {
